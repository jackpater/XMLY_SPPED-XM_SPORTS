#作者：https://github.com/Zero-S1/xmly_speed
import requests
import json
import rsa
import base64
...
UserAgent = "ting_2.0.9(16th,Android29)"
...
def read(cookies):
    ...
    headers = {
        ...
        'user-agent': 'Dalvik/2.1.0 (Linux; U; Android 10; 16th Build/QKQ1.191222.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.100 Mobile Safari/537.36 iting(main)/1.8.18/android_1 kdtUnion_iting/1.8.18',
...
def serverJ(title, content):
    print("\n")
    sckey = SCKEY
    #if "SCKEY" in os.environ:#判断是否运行自GitHub action,"SCKEY" 该参数与 repo里的Secrets的名称保持一致
